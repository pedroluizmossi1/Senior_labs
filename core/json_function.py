...
class JsonFunctions():
    ...
    def append_new_message_to_json_file(self, json_data, file_path_json):
        data = JsonFunctions.read_json_file('read',file_path_json)
        data.append(json_data)
        JsonFunctions.save_json_file('save',data, file_path_json)
